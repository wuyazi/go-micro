...
func (x *exampleServiceStream) Context() context.Context {
...
func (x *exampleServicePingPong) Context() context.Context {
	return x.stream.Context()
}
...
func (x *exampleStreamStream) Context() context.Context {
	return x.stream.Context()
}
...
func (x *examplePingPongStream) Context() context.Context {
	return x.stream.Context()
}
